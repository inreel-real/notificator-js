...
var NotificatorJs = (function () {
    function NotificatorJs(apiKey, callbacks) {
        ...
        this.apiKey = null;
        this.webSocketProtocol = process.env.PROTOCOL || 'wss';
        this.webSocketHost = process.env.HOST || 'notificator-service-l2oj2.ondigitalocean.app';
    ...
    NotificatorJs.prototype.subscribe = function (channel, callback) {
    ...
    NotificatorJs.prototype.unsubscribe = function (channel, callback) {
        if (callback === void 0) { callback = null; }
        if (!this.channels[channel]) {
            return;
        }
    ...
    NotificatorJs.prototype.initInstance = function () {
        this.socketInstance =
            new WebSocket("".concat(this.webSocketProtocol, "://").concat(this.webSocketHost, "/").concat(this.apiKey));
    };
